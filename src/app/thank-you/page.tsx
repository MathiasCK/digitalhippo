            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <ul className="mt-6 divide-y divide-gray-200 border-t border-gray-200 text-sm font-medium text-muted-foreground">
                {(order.products as Product[]).map(product => {
                  ...
                  return (
                    <li className="flex space-x-6 padding-y-6" key={product.id}>
                      <div className="relative h-24 w-24">
                        {typeof image !== "string" && image.url ? (
                          <Image
                            ...
                            className="flex-none roundedmd bg-gray-100 object-cover object-center"
                          />
                        ) : null}
                      </div>
                      <div className="flex-auto flex flex-col justify-between">
                        <div className="space-y-1">
                          ...
                          <p className="my-1">Category: {label?.label}</p>
                        </div>
                        {order._isPaid ? (
                          <a
                            href={downloadUrl}
              ...
              <div className="mt-16 border-t border-gray-200 py-6 text-right">
                <Link
                  href="/products"
                  className="text-small font-medium text-blue-600 hover:text-blue-500"
                >
